...
>
	<Card.Root class="@container/card">
		...
		<Card.Footer class="flex-col items-start gap-1.5 text-sm">
			<div class="line-clamp-1 flex gap-2 font-medium">
				Trending up this month <TrendUpIcon class="size-4" />
			</div>
	...
	<Card.Root class="@container/card">
		...
		<Card.Footer class="flex-col items-start gap-1.5 text-sm">
			<div class="line-clamp-1 flex gap-2 font-medium">
				Down 20% this period <TrendDownIcon class="size-4" />
			</div>
	...
	<Card.Root class="@container/card">
		...
		<Card.Footer class="flex-col items-start gap-1.5 text-sm">
			<div class="line-clamp-1 flex gap-2 font-medium">
				Strong user retention <TrendUpIcon class="size-4" />
			</div>
	...
	<Card.Root class="@container/card">
		...
		<Card.Footer class="flex-col items-start gap-1.5 text-sm">
			<div class="line-clamp-1 flex gap-2 font-medium">
				Steady performance increase <TrendUpIcon class="size-4" />
			</div>
